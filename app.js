...
// "this" refers to the joe object which is an instance of the Student prototype.
// 2. What is "this" when joe.scopeArrow() is invoked?
//This refers to the outer scope where the arrow function is defined in this case.
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not create their own 'this' context but inherit from the outer scope.